 ...
 *  - Changed some things regarding nuclear segmentation (median filtering is now properly done for global thresholding)
 ...
 *  
 *  version 4.61 January 2021:
 *  - Fixed a mistake where auto global threshold was not median filtered
 *  - Tiny improvements in user interface regarding setting the threshold
 */
...
var nucleiGlobalThresholdMethod = "Li";
...
//waitForUser("after median filter");
			setAutoThreshold(nucleiGlobalThresholdMethod+" dark");
